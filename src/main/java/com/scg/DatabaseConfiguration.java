...
public class DatabaseConfiguration {
	...
	public DataSource dataSource() {
		...
		dataSource.setUrl("jdbc:log4jdbc:mysql://localhost:3306/ileanlife?autoReconnect=true&useSSL=false");
		dataSource.setUsername("ileanlife");
		dataSource.setPassword("ss760323");
		return dataSource;
	}
