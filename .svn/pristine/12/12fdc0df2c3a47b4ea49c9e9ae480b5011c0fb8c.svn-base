...
<div class="container">
  <div class="jumbotron">
    <h2><span class="glyphicon glyphicon-edit"> "몸싸커"-이용약관</span></h2>


    <h3>
      제 1 조 (목적)
    </h3>
    이 약관은 주식회사 몸소프트(이하 "회사”라 합니다)이 제공하는 몸싸커 서비스(이하 "서비스”라 합니다)와 관련하여, 회사와 이용 고객간에 서비스의 이용조건 및 절차, 회사와 회원간의 권리, 의무 및 기타 필요한 사항을 규정함을 목적으로 합니다. 본 약관은 PC통신, 스마트폰(안드로이드폰, 아이폰 등) 앱, 오프라인강의 중계 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 준용됩니다.

    <h3>
      제 2 조 (용어의 정의)
    </h3>
    <div>
      1. “사이트”란 “업주”가 미션피드백, 미션심사 또는 서비스 상품(이하 “미션피드백, 미션심사 등”이라 합니다)을 “이용자”에게 판매하기 위하여, “회사”가 컴퓨터 등 정보통신설비를 이용하여 미션피드백, 미션심사 등을 거래할 수 있도록 설정하여 제공하는 가상의 영업장을 말합니다.
    </div><div>
    2. “회원”이라 함은 “몸싸커”에 개인정보를 제공하여 회원등록을 한 자로서, “몸싸커”의 정보를 지속적으로 제공받으며, “몸싸커”이 제공하는 서비스를 계속적으로 이용할 수 있는 자를 의미하고, “몸싸커” 광고업소는 포함되지 않습니다.
  </div><div>
    3. “비회원”이라 함은 “회원”으로 가입하지 않고 “회사”가 제공하는 서비스를 이용하는 자를 말합니다.
  </div><div>
    4. “비밀번호(Password)”라 함은 회원의 동일성 확인과 회원의 권익 및 비밀보호를 위하여 회원 스스로가 설정하여 사이트에 등록한 영문과 숫자 등의 조합을 말합니다.
  </div><div>
    5. “게시물”이라 함은 “회원”이 서비스를 이용함에 있어 서비스 상에 게시한 부호ㆍ문자ㆍ음성ㆍ음향ㆍ화상ㆍ동영상 등의 정보 형태의 글, 사진, 동영상 및 각종 파일과 링크 등을 의미합니다.
  </div><div>
    6. “바로결제서비스”라 함은 “회원”이 “업주”의 “미션피드백, 미션심사 등”을 주문, 결제할 수 있도록 “회사”가 제공하는 서비스를 말하며, 결제방식은 바로결제방식과 만나서결제방식으로 나누어집니다.
  </div><div>
    7. “업주”란 “회사”가 제공하는 “서비스”를 이용해 “미션피드백, 미션심사 등”에 관한 정보를 게재하고, 판매(조리 및 배달포함)하는 주체를 말합니다.
  </div>
    <h3>
      제 3 조 (약관의 명시와 개정)
    </h3>
    ...
    <br>2. “회사”는 『전자상거래 등에서의 소비자보호에 관한 법률』, 『약관의 규제등에 관한 법률』, 『전자문서 및 전자거래기본법』, 『전자서명법』, 『정보통신망 이용촉진 등에 관한 법률』, 『소비자기본법』 등 관련법령을 위배하지 않는 범위에서 이 약관을 개정할 수 있습니다.
    <br>3. “회사”는 약관을 개정할 경우에는 적용일자 및 개정사유를 명시하여 현행약관과 함께 “사이트”의 초기화면에 그 적용일자 7일 이전부터 적용일자 전일까지 공지합니다. 다만, “이용자”에게 불리하게 약관내용을 변경하는 경우에는 최소한 30일 이상의 사전 유예기간을 두고 공지합니다. 이 경우 “회사”는 개정 전과 개정 후 내용을 “이용자”가 알기 쉽도록 표시합니다.
    <br>4. “회원”은 변경된 약관에 동의하지 않을 권리가 있으며, 변경된 약관에 동의하지 않을 경우에는 서비스 이용을 중단하고 탈퇴를 요청할 수 있습니다. 다만, “이용자”가 제3항의 방법 등으로 “회사”가 별도 고지한 약관 개정 공지 기간 내에 “회사”에 개정 약관에 동의하지 않는다는 명시적인 의사표시를 하지 않는 경우 변경된 약관에 동의한 것으로 간주합니다.
    <br>5. 이 약관에서 정하지 아니한 사항과 이 약관의 해석에 관하여는 『전자상거래 등에서의 소비자보호에 관한 법률』, 『약관의 규제 등에 관한 법률』, 공정거래위원회가 정하는 『전자상거래 등에서의 소비자보호지침』 및 관계 법령 또는 상관례에 따릅니다.
    ...
    1) “미션피드백, 미션심사 등”에 대한 광고플랫폼 서비스
  </div><div>
    2) “미션피드백, 미션심사 등”에 대한 온라인 연결 플랫폼서비스
  </div><div>
    3) 기타 “회사”가 정하는 서비스
  </div><div>
    ...
    <div>“회원”이 작성한 게시물에 대한 저작권 및 모든 책임은 이를 게시한 “회원”에게 있습니다. 단, “회사”는 “회원”이 게시하거나 등록하는 게시물의 내용이 다음 각 호에 해당한다고 판단되는 경우 해당 게시물을 사전통지 없이 삭제 또는 임시조치(블라인드)할 수 있습니다.</div>
    <div>
    ...
    - 게시중단요청: 01024991591 // ishimsungbo@gmail.com
  </div>
    <h3>제 13 조 (이용제한 등)</h3>
    <div>
    ...
    2. “회사”는 “회원”이 안전하게 “서비스”를 이용할 수 있도록 개인정보(신용정보 포함)보호를 위해 개인정보취급방침을 수립하여 공시하고 준수합니다.
  </div><div>
    ...
    <h3>제 18 조 (포인트)</h3>
    <div>
      1. 포인트는 “서비스”를 통해 “미션피드백, 미션심사 등”을 구매하는 경우 대금 결제 수단으로 사용할 수 있는 현금 등가 등의 결제수단을 의미합니다.
    </div><div>
    ...
    9. 회사는 회원에게 무료로 지급된 이벤트성 포인트에 대해 환불할 의무가 없습니다.
  </div><div>
    10. 강사회원은 적립된 포인트가 30만 포인트이상 쌓여야 현금 지급, 기타 서비스 특혜로 전환 될 수 있으며, 전환 후에는 모든 적립 포인트가 소멸됩니다.
  </div>
    ...
    <div>
      2. “회사”는 “회원”의 개인정보를 보호하기 위한 개인정보취급방침을 수립하여 서비스 초기화면에 게시합니다. 다만, 개인정보취급방침의 구체적 내용은 연결화면을 통하여 볼 수 있습니다.
    </div>
    <div>
      3. “회사”는 관련법령 및 개인정보취급방침에 따라 “회원”의 개인정보를 최대한 보호하기 위하여 노력합니다.
    </div>
    <div>
      4. “회사”의 공식 사이트 이외의 링크된 사이트에서는 “회사”의 개인정보취급방침이 적용되지 않습니다. 링크된 사이트 및 구매 상품이나 서비스를 제공하는 제3자의 개인정보 취급과 관련하여는 해당 사이트 및 해당 제3자의 개인정보취급방침을 확인할 책임이 “회원”에게 있으며, “회사”는 이에 대하여 책임을 부담하지 않습니다.
    </div>
    <h3>
      제 20 조 (주문 및 결제, 포인트 소진)</h3>
    <div>
      1. “미션피드백, 미션심사(피드백) 등”에 대한 요청을 강사에게 하고 강사가 답변을 하면 최종소진 되면 환불은 불가능 합니다. 단, 강사의 피드백이 작성되기 전에 취소를 함으로써 포인트를 회수 할 수 있습니다. 미션 심사요청도 위와 동일합니다
    </div><div>
    2. “회원”은 다음 또는 이와 유사한 방법에 의한 구매를 신청할 수 있습니다.
  </div><div>
    3. 몸싸커는 웹페이지/앱 외에서의 주문 및 결재 포인트 거래에 대한 책임이 없을 명시합니다.
  </div>
    <h3>
      제 21 조 (취소・환불)</h3>
    <div>
      1. “미션피드백, 미션심사 등”에 대한 취소 및 환불 규정은 전자상거래등에서의 소비자보호에 관한 법률 등 관련 법령을 준수합니다.
    </div>
    <div>
      2. “회사”는 별도의 취소 및 환불 관련 규정을 정할 수 있으며, 이 경우 별도 계약 및 이용조건상의 취소 및 환불 규정이 우선 적용됩니다.
    </div><div>
    3. “회사”는 “회원”이 본 조에 따라 결제를 통한 구매에 대해 청약철회를 하고 “강사”의 승인이 있는 경우 또는 제공한 피드백이 “회사” 피드백 규정에 어긋나는 경우 지체 없이 그 사유를 “회원”에게 통지하고, 결제 내역을 취소하거나 대금을 받은 경우에는 환급에 필요한 조치를 취합니다.
  </div><div>
    4. 취소와 환불은 “강사”와 확인 후 처리 하게 되며, 신용카드결제 및 핸드폰결제는 신용카드사 및 이동통신사의 환불기준에 의거하여 처리가 완료되는데 시일이 소요될 수 있습니다.
  </div><div>
    5. 오프라인 강의에 대한 환불정책은 과외 교습에 관련 법률 시행령을 따릅니다.
  </div>
    <h3>
      제 22 조 (책임제한)</h3>
    <div>
      1. “회사”는 “강사”와 “일반회원” 간의 피드백 거래를 중개하는 플랫폼 서비스만을 제공할 뿐, “피드백 등”을 판매하는 당사자가 아니며, “피드백 등”에 정보 및 영상 문제에 대한 책임은 “강사”에게 있습니다.
    </div>
    <div>
      2. “회사”는 천재지변 또는 이에 준하는 불가항력으로 인하여 “서비스”를 제공할 수 없는 경우에는 서비스 제공에 관한 책임이 면제됩니다.
    </div>
    <div>
      3. “회사”는 “회원”의 귀책사유로 인한 “서비스” 이용의 장애에 대하여는 책임을 지지 않습니다.
    </div>
    <div>
      4. “회사”는 “강사회원” 및 “일반회원”이 게재한 운동방법, 코칭자료(영상,사진,링크사이트)등 신뢰도, 정확성에 대해서는 책임을 지지 않습니다.
    </div>
    <div>
      5. “회사”는 제3자가 서비스 내 화면 또는 링크된 웹사이트를 통하여 광고한 제품 또는 서비스의 내용과 품질에 대하여 감시할 의무 기타 어떠한 책임도 지지 아니합니다.
    </div>
    <div>
      6. “회사”는 “회원 및 강사”가 서비스를 이용하여 기대하는 수익을 상실한 것에 대하여 책임을 지지 않으며, 그 밖의 서비스를 통하여 얻은 자료로 인한 손해에 관하여 책임을 지지 않습니다.
    </div>
    <div>
      7. “회사”는 “회원”간 또는 “회원”과 제3자 상호간에 서비스를 매개로 하여 거래 등을 한 경우에는 책임이 면제됩니다.
    </div>
    <div>
      8. “회사” 및 “회사”의 임직원 그리고 대리인은 고의 또는 중대한 과실이 없는 한 다음과 같은 사항으로부터 발생하는 손해에 대해 책임을 지지 아니합니다.
    </div>
    <div>
      ...
      5) 오프라인 강의 도중 본인의 부주의 및 훈련 중 발생한 부상에 대해서는 몸싸커 및 강사가 책임을 지지 않습니다.
      6) 강사와의 교습 중 불미스러운 사건에 대해서도 몸소프트는 중계인으로서 어떠한 책임도 지지 않음을 알려드립니다.
    </div>
    <h3>
      제 23 조 (오프라인 레슨 서비스 대한 특칙)</h3>
    <div>
      1. “오프라인 레슨 서비스”란 “강사”와 “회원”이 몸싸커를 통해 접촉 후 오프라인 레슨 계약을 체결한 것을 말합니다
    </div>
    <div>
      2. 몸소프트의 몸싸커는 본사가 온라인 앱 공간 및 플랫폼 서비스를 제공할 뿐이며, 본 서비스(온라인 영상 미션 피드백 및 심사결과) 외, 오프라인 레슨을 일반 회원과 강사회원이 체결한 경우와 그로 인한 불미스러운 사고등에 관해서 어떠한 책임도 지지 않습니다.
    </div>
    <h3>
      제 24 조 (접속 디바이스 고유번호 수집에 대한 특칙)
    </h3>
    <div>
      1. 회사는 회원의 서비스 접속 디바이스(핸드폰,탭) 등의 고유번호를 수집합니다.
      2. 회사는 원활한 푸쉬서비스를 구현하기 위해 고유번호를 수집할 뿐 3자에게 제공하지 않으며, 이외의 서비스에 이용하지 않습니다. 또한 서비스 탈퇴시 회원정보와 함께 5일이내에 자사의 DB에서 폐기(영구 삭제처리)함을 공지합니다.

      <h3>제 25 조 (회원 갤러리의 동영상 및 사진 수집, 업로드 에 대한 특칙)</h3>
      <div>
        1.회사는 회원이 업로드하는 갤러리의 사진 및 영상에 관해서만 DB에 저장합니다. 단) 영상은 자체 서버에 저장 하지 않으며 유투브에 업로드되며, 회원 로컬 디바이스 기기의 자료를 검색하거나 이용하지 않습니다.
      </div>
      <div>
        2.유투브에 업로드된 영상으로 인해 발생되는 문제는 회사가 책임지지 않으며 유투브와 몸싸커의 회원간의 분쟁 문제이며 회사는 어떠한 분쟁도 책임지지 않습니다.
      </div>
      <div>
        3.업로드된 동영상이 회사 서비스의 취지와 맞지 않게 저작권이 위배되는 영상을 업로드 했을 경우, 업로드한 회원에게 책임이 있음을 명시하며, 회사는 링크 주소를 DB 에 저장 할 뿐, 모든 문제의 책임은 회원에게 있음을 명시하며, 회사는 어떠한 책임도 지지 않습니다.
      </div>
      ...
      <div>1. 이 약관의 해석 및 회사와 회원간의 분쟁에 대하여는 대한민국의 법을 적용합니다.</div>
      <div>2. 서비스 이용 중 발생한 회원과 회사간의 소송은 민사소송법에 의한 관할법원에 제소합니다.</div>

      <h3>부칙</h3>
      1. 이 약관은 2016년 12월 13일부터 시행됩니다.
