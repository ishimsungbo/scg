      ...
      <div class="jumbotron">
        ...
        <div class="row">
          <div class="col-sm-6 col-md-6">
            <a data-toggle="modal" data-target="#myModal" data-whatever="${list.uservideo}" data-name="${list.username}">
              <img style="width: 100%; margin-bottom: 5px" src="http://img.youtube.com/vi/${list.uservideo}/hqdefault.jpg" alt="미션 챌린지 이미지">
            </a>
          ...
          <div class="col-sm-6 col-md-6">
            ...
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title">유저명 : ${list.username}</h3>
              </div>
              <div class="panel-body">
                <p>팀명 :
                  <c:if test="${list.teamname == null}">
                    팀 가입전
                  </c:if>
                  <c:if test="${list.teamname != null}">
                    ${list.teamname}
                ...
                <p>경험치 : ${list.totalscore}</p>
                <p>
                  <c:if test="${list.passflag == 'Y'}">
                    도전 성공
                  </c:if>
                  <c:if test="${list.passflag != 'Y'}">
                    심사대기중
